...
public class TwoTest{
    ...
    public void createPostHistory() throws JsonProcessingException {
        ...
        responseBodyEmployee = objectMapper.readValue(response, EmployeeResponse.class);
        assertThat(responseBodyEmployee.getData().getAge(), equalTo("20"));

    }
    @Test
    public void createEmployeeWitSalary() throws JsonProcessingException {
        ...
        assertThat(postRequest.getSalary(),equalTo(responseBodyEmployee.getData().getSalary()));

    }
    @Test
    public void createEmployeePoswithID() throws JsonProcessingException {
        PostRequest postRequest = new PostRequest.Builder().postFitccion().build();
        String response=
                given()
                        .body(postRequest)
